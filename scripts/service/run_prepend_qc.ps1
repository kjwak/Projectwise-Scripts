...
if (-not $NoDashboard) {
  $dash = Join-Path $repoRoot 'scripts\service\Start-QCPipelineDashboard.ps1'
...
$watcher = Join-Path $repoRoot 'scripts\service\Watch-QCTrigger.ps1'
$worker = Join-Path $repoRoot 'scripts\service\Run-QCProcessor.ps1'
