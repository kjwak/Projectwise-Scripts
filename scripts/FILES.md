...
| Location | Examples |
| --- | --- |
| `deployment/` | `Promote-DevToMain`, `Sync-OverlayReviewStamp`, `Register-QCPipelineDashboardTask`, `Register-QCPipelineDashboardLogonConsole`, `Set-QCScheduledTaskOperatorAcl`, `Register-QCRemoteWorkerHostTask` |
