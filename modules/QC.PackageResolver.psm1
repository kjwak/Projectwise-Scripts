...
function Get-QCPackageSettings {
    ...
    $defaults = @{
        ...
        statePrecedence = @('Error Needs Attention','Initiate Origination','Initiate Verification','Originated','Ready for Verification','Verified','Redlines Received','In Development')
